...
It will convert it to a SIF file and write it in your current directory.
...
You can set this custom cache directory location in your `~/.bashrc` or `~/.zshrc`:
...
```
> /data/sovacoolkl/.singularity

(Your own username will appear instead of `sovacoolkl`.)
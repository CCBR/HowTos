...
Here's an example of pulling a container from the CCBR dockerhub account:
...
This is the base image that we use for building most other CCBR containers.

![<https://hub.docker.com/repository/docker/nciccbr/ccbr_ubuntu_22.04/general>](img/dockerhub-ubuntu-base.png)

![CCBR base image overview with list of installed tools](img/dockerhub-ubuntu-base-overview.png)

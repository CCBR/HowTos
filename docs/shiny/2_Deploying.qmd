...
-   Used for sharing outside of NCI
...
![Select the add new account button (red box)](Publish_from_account_window.png){width="500"}

Next choose the "Posit Connect" option and in the next window enter the URL for the NCI Posit Connect dev server.

![](Connect_account_options.png){width="500"}

![](Posit_connect_enter_URL.png){width="500"}
...
![The connection prompt appearing on the Posit Connect dev server](Connect_to_R_prompt.png){width="500"}
...
![](images/Deploying_example_app-01.png){width="500"}
...
![](images/Screenshot 2025-11-07 at 11.00.10 AM.png)

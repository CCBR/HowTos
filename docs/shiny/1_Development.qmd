...
Where \$gh_username will replace with your github username.
...
If the restore function causes issues or is not preferred, the required libraries can also be installed individually. All required libraries are listed at the top of the app.R file and the sourced R script files (for shiny-example that's "R/PCA_plot_DSP.R" and "R/violin_boxplot.R").

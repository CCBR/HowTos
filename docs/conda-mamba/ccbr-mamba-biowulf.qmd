...
Note that the channel URLs point to https://conda.anaconda.org/conda-forge/ and
https://conda.anaconda.org/bioconda/ (only **community-supported channels**),
and no channels point to `https://repo.anaconda.com` (no commercial channels).

New environments you create will be in `/data/$USER/mamba/envs/`, but you will also

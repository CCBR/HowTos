...
::: {.notes}
check that AI generated code works how you expect. ideally, make sure you understand it.
:::
...
- Remember: generative AI tools use statistical models to produce outputs that look like a plausible response to a prompt.
- AI tools accelerate bioinformatics; just make sure you're facing the direction you want to go. 🚀

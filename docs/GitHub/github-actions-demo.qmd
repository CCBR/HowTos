...
description: Intro to GitHub Actions for Analysts & Engineers
author: "Kelly Sovacool"
---

- Demo: <http://sovacool.dev/gh-actions-demo/>
- Example code and workflow files used in the demo: <https://github.com/kelly-sovacool/gh-actions-sandbox>

...
Do not cut a release if any of the tests fail or if the pipeline throws errors
during the test run. We only want to release working software!
...
You can verify that the installation worked by reloading the module and checking
the version of the pipeline/tool:

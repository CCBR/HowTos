...
1. Ensure your repo has the following files:
...
1. Run the `draft-release` workflow

  ![](./draft-release-workflow.png)

1. Once `draft-release` completes successfully, a new draft release will appear under the releases page
...
1. Review the Pull Request opened by the `post-release` workflow.
...
1. Install the new release on Biowulf.
